      ...
      <div className="max-w-md w-full space-y-8">
            ...
            <div>
              <div class="relative flex items-center">
                <input
                  ...
                  name="avatar"
                  type="avatar"
                  class="pr-4 pl-14 py-2.5 text-sm text-black rounded bg-white border border-gray-400 w-full outline-[#2e3236]"
                  onChange={handleInputChange}
        ...
        {registrationStatus === "success" && (
          <p className="text-green-600 text-center">
            ...
            <Link to="/login" className="border p-2 text-blue-500 ">
              Login
            </Link>
            .
          </p>
